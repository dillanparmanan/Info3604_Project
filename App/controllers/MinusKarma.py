from App import get_student_by_id, get_karma_student
from App.controllers.AbstractCommand import AbstractCommand
from App.database import db

class MinusKarma(AbstractCommand):
    def execute(self):
        ...
        try:
            ...
            print(f"[MinusKarma.execute] Error while reducing student {self.student_id}'s karma by {self.karma_diff}: {str(e)}")
            return False